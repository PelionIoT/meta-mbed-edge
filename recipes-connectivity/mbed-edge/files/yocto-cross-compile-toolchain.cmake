...
SET (TARGET_GROUP $ENV{TARGET_GROUP})
...
IF (NOT CMAKE_C_FLAGS)
  ...
  # ASM
  SET (CMAKE_ASM_FLAGS "-mthumb -mapcs" CACHE STRING "")

  # C
  SET (CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -std=gnu99 -MMD -MP" CACHE STRING "")

  # C Debug
  SET (CMAKE_C_FLAGS_DEBUG "${CMAKE_C_FLAGS_DEBUG} -DDEBUG" CACHE STRING "")
  ...
  # CXX Debug
  SET (CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} -DDEBUG -Og" CACHE STRING "")
  ...
  # Linker
  SET (CMAKE_EXE_LINKER_FLAGS "-Xlinker --gc-sections" CACHE STRING "")
